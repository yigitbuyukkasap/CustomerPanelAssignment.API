using CustomerPanelAssignment.API.DataAccess;
...
namespace CustomerPanelAssignment.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // Adding DbContext
            services.AddDbContext<CustomerPanelContext>(options => 
                options.UseSqlServer(Configuration.GetConnectionString("CustomerPanelDb")));
